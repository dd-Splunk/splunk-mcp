...
| SA-S4R MCP tools (`s4r_mcp_tools.json`, `tools.conf`, signatures, saved searches, REST handler) | [MCP-TOOLS.md](../s4r/MCP-TOOLS.md); re-run **`make register-s4r-mcp-tools`** |
...
- Custom / app MCP tools: [MCP-TOOLS.md](../s4r/MCP-TOOLS.md)
