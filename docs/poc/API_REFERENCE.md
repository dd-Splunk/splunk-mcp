...
Official client shape (Splunk MCP Server **2.0**): [Connecting to the MCP Server and settings](https://help.splunk.com/en/splunk-cloud-platform/mcp-server-for-splunk-platform/2.0/connecting-to-the-mcp-server-and-settings). Auth modes (token vs OAuth): [CONFIGURATION.md](CONFIGURATION.md#splunk-mcp-authentication-20).
