...
Splunk MCP Server **1.3** lets an app register tools without a standalone MCP server ([custom tools](https://help.splunk.com/en/splunk-enterprise/mcp-server-for-splunk-platform/1.3/managing-custom-tools-in-splunk-mcp-server)). This PoC:
