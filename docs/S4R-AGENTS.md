...
**Full presenter guide** (26-slide Marp deck, Mermaid diagrams, 20- and 10-minute tracks, copy-paste prompts): **[S4R-DEMO.md](../demo-slides/S4R-DEMO.md)** · **[demo-slides/README.md](../demo-slides/README.md)** (Marp build/preview).
